...
`renderWithTooltips` function accepts also optional `customGrob` parameter. It allows to pass modificated grob object and as a result output tooltips coordinates will fits its geometries.
