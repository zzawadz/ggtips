...
test_that("getGrobCol()", {
  expect_equal(ggtips:::getGrobCol(gt, "panel-1-1"), 4L)
  expect_equal(ggtips:::getGrobCol(gt, "strip-t-2-1"), 8L)
  expect_equal(ggtips:::getGrobCol(gt, "axis-b-3-1"), 12L)
  expect_error(ggtips:::getGrobCol(gt, "i_dont_exist"))
})

test_that("getGrobRow()", {
  expect_equal(ggtips:::getGrobRow(gt, "ylab-l"), 7L)
  expect_equal(ggtips:::getGrobRow(gt, "title"), 2L)
  expect_equal(ggtips:::getGrobRow(gt, "guide-box"), 7L)
...
test_that("columns and rows", {
  ...
  expect_equal(ggtips:::gridColWidth(gt, 5L), 0)
